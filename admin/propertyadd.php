							...
							<div class="card-body">
								...
								<div class="row">
									...
									<div class="col-xl-6">
										...
										<div class="form-group row">
											<label class="col-lg-2 col-form-label">Selling Type</label>
											<div class="col-lg-10">
										...
										<div class="form-group row">
											...
											<div class="col-lg-10">
												<input type="text" class="form-control" name="kitc"
									...
									<div class="col-xl-6">
										...
										<div class="form-group row">
											<label class="col-lg-2 col-form-label">Bedroom</label>
											<div class="col-lg-10">
										...
										<div class="form-group row">
											<label class="col-lg-2 col-form-label">Balcony</label>
											<div class="col-lg-10">
												<input type="text" class="form-control" name="balc"
													placeholder="Enter Balcony  (only no 1 to 10)">
											</div>
										</div>
										<div class="form-group row">
											<label class="col-lg-2 col-form-label">Hall</label>
											<div class="col-lg-10">
								...
								<div class="row">
									...
									<div class="col-xl-6">
										...
										<div class="form-group row">
											<label class="col-lg-2 col-form-label">Area Size</label>
											<div class="col-lg-10">
								...
								<div class="row">
									<div class="col-xl-6">
										...
										<div class="form-group row">
											<label class="col-lg-2 col-form-label">Basement Floor Plan Image</label>
											<div class="col-lg-10">
									...
									<div class="col-xl-6">
										...
										<div class="form-group row">
											<label class="col-lg-2 col-form-label">Floor Plan Image</label>
											<div class="col-lg-10">
												<input class="form-control" name="fimage" type="file" required>
											</div>
										</div>
										<div class="form-group row">
											<label class="col-lg-2 col-form-label">Ground Floor Plan Image</label>
											<div class="col-lg-10">
								...
								<div class="row">
									<div class="col-md-6">
										<div class="form-group row">
											<label class="col-lg-2 col-form-label"><b>Is Featured?</b></label>
											<div class="col-lg-10">
