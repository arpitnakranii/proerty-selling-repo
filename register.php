...
if(isset($_REQUEST['reg']))
{
	...
	else
	{
		...
		if(!empty($name) && !empty($email) && !empty($phone) && !empty($pass) )
		{
			...
			// 	$msg = "<p class='alert alert-success'>Password must contain at least one uppercase letter.</p>";
			// } elseif (!preg_match('/[!@#$%^&*()\-_=+{};:,<.>]/', $pass)) {
			// 	$msg =  "<p class='alert alert-success'>Password must contain at least one special character.</p>";
			// }
			// else{
				$pass= sha1($pass);
				$sql="INSERT INTO user (uname,uemail,uphone,upass,utype,uimage) VALUES ('$name','$email','$phone','$pass','$utype','$uimage')";
                        ...
                        <div class="login-right">
							<div class="login-right-wrap">
								...
								<form method="post" enctype="multipart/form-data">
									...
									<div class="form-group">
										<input type="password" minlength="5" maxlength="10" name="pass"  class="form-control" placeholder="Your Password*" id="password">
										<span class="password-toggle-icon d-none"><i class="fas fa-eye"></i></span>
									</div>

									 <div class="form-check-inline">
									  <label class="form-check-label">
										<input type="radio" class="form-check-input" name="utype" value="user" checked require="true">User
									  </label>
									</div>
									<div class="form-check-inline">
									  <label class="form-check-label">
