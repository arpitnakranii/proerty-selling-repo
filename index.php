                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-8 col-lg-6">
                                        ...
                                        <select class="form-control " name="city">
																<option value="" disabled selected disabled selected>Select</option>
																<?php
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>We are aware that when you decide to sell your property, it is not an experience that is only about mere agreements, down payments and percentages. We are enthusiastic about proving you with a proper experience because the whole process is significant and sentimental to us.</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>we providing you to facilitate the leasing or renting of properties to tenants. This involves tasks such as marketing available properties, conducting property viewings, screening potential tenants, negotiating lease agreements, collecting rent payments, and managing maintenance and repairs of the rental properties.</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>In property listing within the real estate industry, the primary objective is to effectively market properties for sale or rent to potential buyers or tenants. This involves creating comprehensive and enticing listings that accurately represent the properties, highlighting their features, amenities, and unique selling points.</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>Legal investment in real estate involves adhering to local laws, regulations, and zoning ordinances when purchasing properties. It includes conducting due diligence, obtaining necessary permits, and ensuring compliance with property use restrictions. This approach safeguards investments, mitigates risks, and fosters transparency in real estate transactions.</p>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <ul>
                                <li class="mb-4 text-white d-flex"> 
									...
									<div class="pl-2">
										...
										<p>Choose us for top-rated real estate services due to our proven track record, extensive market knowledge, exceptional customer service, and dedication to achieving your property goals efficiently.</p>
									</div>
                                </li>
                                <li class="mb-4 text-white d-flex"> 
									...
									<div class="pl-2">
										...
										<p>Choose us for experienced, high-quality real estate services. Our expertise, attention to detail, and commitment to excellence ensure a seamless and satisfactory experience for all your property needs.</p>
									</div>
                                </li>
                                <li class="mb-4 text-white d-flex"> 
									...
									<div class="pl-2">
										...
										<p>Choose us for experienced real estate agents who understand the market intricacies, offer personalized guidance, and prioritize your needs, ensuring a smooth and successful property transaction every time.</p>
									</div>
                                </li>
                            </ul>
                        </div>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <p>we are covering market trends, investment strategies, property valuation, legal considerations, and industry regulations. Participants share insights, seek advice, and exchange knowledge on buying, selling, renting, and managing properties for informed decision-making.</p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <p>After the Discussion with coustomer, files review involves examining legal documents, contracts, deeds, and financial records related to property transactions. It ensures compliance, accuracy, and transparency in real estate deals, mitigating risks for all parties involved.</p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <p>Real estate acquisition involves identifying investment opportunities, conducting due diligence, negotiating deals, and finalizing property purchases. It entails assessing market conditions, property values, potential returns, and risks to make informed decisions on acquiring real estate assets.</p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-lg-3 pb-1">
                            <div class="overflow-hidden position-relative overlay-secondary hover-zoomer mx-n13 z-index-9"> <img src="images/thumbnail4/1.jpg" alt="">
                                <div class="text-white xy-center z-index-9 position-absolute text-center w-100">
									<?php
										$query=mysqli_query($con,"SELECT count(state), property.* FROM property where city='Bharuch'");
											while($row=mysqli_fetch_array($query))
												{
										?>
                                    <h4 class="hover-text-success text-capitalize"><a href="stateproperty.php?id=<?php echo $row['17']?>"><?php echo $row['state'];?></a></h4>
