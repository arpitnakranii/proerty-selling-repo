...
if(isset($_REQUEST['login']))
{
	...
	if(!empty($email) && !empty($pass))
	{
		...
		$error = "<p class='alert alert-warning'>Wrong password</p>";
		   if($row){
							...
							<div class="login-right-wrap">
								...
								<form method="post">
									...
									<div class="form-group ">
										...
										<input type="password" name="pass"  class= "form-control" placeholder="Your Password" id="password" value="">Show / Hide Password
										...
										<a href="verify_otp.php">Forgot Password?</a>
