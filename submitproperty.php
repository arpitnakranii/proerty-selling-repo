							...
							<div class="description">
								...
								<div class="row">
									...
									<div class="col-xl-6">
											...
											<div class="col-lg-8">
												<select class="form-control " name="bath">
													...
													while ($i < 10) {
														$i++;
													?>
														<option value="<?php echo $i; ?>" class="text-captalize">
															<?php echo $i; ?></option>
													<?php } ?>
												</select>
											</div>
										...
										<div class="form-group row">
											<label class="col-lg-4 col-form-label">Kitchen :</label>
											<div class="col-lg-8">
									...
									<div class="col-xl-6">
										<div class="form-group row mb-3">
											<label class="col-lg-4 col-form-label">BHK :</label>
											<div class="col-lg-8">
										...
										<div class="form-group row">
											<label class="col-lg-4 col-form-label">Hall :</label>
											<div class="col-lg-8">
								...
								<div class="row">
									...
									<div class="col-xl-6">
										...
										<div class="form-group row">
											<label class="col-lg-4 col-form-label">Area Size</label>
											<div class="col-lg-8">
								...
								<div class="row">
									<div class="col-xl-6">
										...
										<div class="form-group row">
											<label class="col-lg-4 col-form-label">Basement Floor Plan Image :</label>
											<div class="col-lg-8">
									...
									<div class="col-xl-6">
										...
										<div class="form-group row">
											<label class="col-lg-4 col-form-label">Floor Plan Image :</label>
											<div class="col-lg-8">
												<input class="form-control" name="fimage" type="file">
											</div>
										</div>
										<div class="form-group row">
											<label class="col-lg-4 col-form-label">Ground Floor Plan Image :</label>
											<div class="col-lg-8">
